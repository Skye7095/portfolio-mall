				...
				<div class="sellerfind-select d-flex justify-content-around">
					<ul class="nav nav-tabs">
					  <li class="nav-item id-tab text-center">
					    <a class="nav-link" href="/user/seller/findID/view"><span class="text-dark">아이디 찾기</span></a>
					  </li>
					  <li class="nav-item pw-tab text-center">
					    <a class="nav-link active" href="/user/seller/resetPW/view"><span class="text-white font-weight-bold">비밀번호 재설정</span></a>
					  </li>
					</ul>
				</div>
