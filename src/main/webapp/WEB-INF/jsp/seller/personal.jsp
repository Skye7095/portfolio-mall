				...
				<article class="container content">
					<div class="bio d-flex justify-content-between align-items-end">
						<div class="d-flex justify-content-around align-items-end">
							...
							<div class="ml-3">
							<span class="display-5 font-weight-bold">${sellerList.name }님
							<br>
							가입일: ${sellerList.createdAt }</span>
							</div>	
						</div>
						<button class="btn btn-primary" id="buyerSignUpBtn">구매회원 가입</button>
					</div>
					...
					<div class="otherbox mt-5">
						...
						<div class="phone mt-3">
							<div class="d-flex justify-content-between align-items-center">
								...
								<input type="text" class="form-control col-10" value="${sellerList.phoneNumber }" id="phoneNumberInput">
							</div>
						</div>
						<div class="email mt-3">
							<div class="d-flex justify-content-between align-items-center">
								...
								<input type="text" class="form-control col-10" value="${sellerList.email }" id="emailInput">
