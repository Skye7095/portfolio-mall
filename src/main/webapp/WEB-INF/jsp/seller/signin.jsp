			...
			<div class="signin-card container mt-5">
				...
				<div class="small-signin-card container">
					<div class="signin-select d-flex justify-content-around align-items-center">
						...
						<div class="form-check">
						  <input class="form-check-input" type="radio" name="identity" value="seller" checked>
					...
					<div class="signin-info">
						...
						<div class="links d-flex justify-content-center align-items-end">
							<a class="text-dark" href="/seller/findID/view">아이디찾기</a>&nbsp; | &nbsp;
						    <a class="text-dark" href="/seller/resetPW/view">비밀번호찾기</a>&nbsp; | &nbsp;
						   	<a class="text-dark" href="/seller/signup/view">회원가입</a>
						</div>
				...
				$.ajax({
					...
					, success:function(data){
						if(data.result == "success"){
							location.href="/seller/personal/view";
						}else{
							alert("로그인 실패");
						}
					}
