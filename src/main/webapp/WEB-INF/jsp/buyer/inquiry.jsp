					...
					<div class="identify-select d-flex justify-content-around">
						<ul class="nav nav-tabs">
						  <li class="nav-item buyer-tab text-center">
						    <a class="nav-link active" aria-current="page" href="/buyer/mybbs/myinquerylist/view"><span class="text-white font-weight-bold">문의/답변</span></a>
						  </li>
						  <li class="nav-item seller-tab text-center">
						    <a class="nav-link" href="/buyer/mybbs/myreviewlist/view"><span class="text-dark">리뷰</span></a>
						  </li>
						</ul>
					</div>
