...
<body>
	<div id="wrap">
		...
		<section class="buyerPersonal-section my-5">
				...
				<article class="container content">
					<div class="bio d-flex justify-content-between align-items-end">
						<div class="d-flex justify-content-around align-items-end">
							...
							<div class="ml-3">
							<span class="display-5 font-weight-bold">xxx님(일반회원)
							<br>
							가입일: </span>
							</div>	
						</div>
						<button class="btn btn-primary">판매회원 가입</button>
					</div>
